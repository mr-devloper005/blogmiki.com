...
function getLoginConfig(kind: ReturnType<typeof getProductKind>) {
  ...
  if (kind === 'editorial') {
    return {
      ...
      panel: 'border border-slate-200 bg-white shadow-[0_24px_80px_rgba(15,23,42,0.06)]',
      side: 'border border-indigo-100 bg-gradient-to-br from-indigo-50 to-white',
      muted: 'text-slate-600',
      action: 'bg-indigo-600 text-white hover:bg-indigo-500',
      icon: FileText,
      title: 'Sign in to your reading workspace',
      body: 'Pick up drafts, saved searches, and contributor tools with the same calm editorial shell as the public site.',
    }
  }
  if (kind === 'visual') {
    return {
