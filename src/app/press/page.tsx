...
export default function PressPage() {
  ...
  return (
    <PageShell
      title="Press"
      description="Media resources, brand assets, and recent editorial coverage."
    >
        ...
        <Card className="border-border bg-card">
          <CardContent className="p-6 space-y-3">
            ...
            <p className="text-sm text-muted-foreground">
              Download logos, editorial screenshots, and media guidelines for mentions and interviews.
            </p>
